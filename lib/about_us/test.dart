...
class _FlightsStepperState extends State<FlightsStepper> {
  ...
  Widget build(BuildContext context) {
    if (pageNumber == 1 ||pageNumber == 2  ) {
        ...
        answers: <String>[ 'Other question','gyjgjgjk',],
        number: 1,
      )
          : Page(
        key: Key('page2'),
        onOptionSelected: () => setState(() => pageNumber = 3),
        question: "why would i use your app than using a phone ??"
            "\n\n-this app is the one huge medical"

            "hassle fo finding clinics details." ,
        answers: <String>[ 'Other question','kk'],
        number: 2,
      );
       ...
       page2 = pageNumber == 3
        ...
        "why would i use your app than using a phone ??"
            ...
            "hassle fo finding clinics details." ,
        answers: <String>[ 'Other question','km'],
        number: 3,
      )
          : Page(
        key: Key('page4'),
        ...
        question: "why would i use your app than using a phone ??"
            ...
            "hassle fo finding clinics details." ,
        answers: <String>[ 'Other question','mp'],
        number: 4,
      );
    ...
    OverlayEntry entry = OverlayEntry(
      builder: (context) {
        ...
        return AnimatedBuilder(
          ...
          child: _animationController.isCompleted ? Dot() : Dot2(),
        );
      },
    );
...
class Dot2 extends StatelessWidget {
  ...
  const Dot2({Key key, this.visible = true}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Icon(Icons.airplanemode_active,color: visible? Colors.white: Colors.transparent,size: 50,),
    );
  }
}
...
const backgroundDecoration = BoxDecoration(
  gradient: LinearGradient(
    colors: [Color(0xff5097a4),Color(0xff5097a4),],
